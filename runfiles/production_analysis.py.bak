...
def well_production_analysis(production_data, production_data_headings, well_data, well_data_headings):
	...
	yearly_prod_data = collections.OrderedDict(sorted(yearly_prod_data.items(), key=lambda t: t[0]))
	...
	while plot_option != 0:
		...
		plt.xlabel('Month')
		plt.xticks(range(0,months_assessed),range(1,months_assessed+1))
