...
ask_production = str(raw_input('Get Production Data (Y/N) ?:   '))
print('\n')
...
ask_injection = str(raw_input('Get Injection Data (Y/N) ?:   '))
print('\n')
...
ask_fluid_data = str(raw_input('Get Fluid Data (Y/N) ?:   '))
print('\n')
...
ask_DST_data = str(raw_input('Get Pressure/DST data (Y/N)?:  '))
print('\n')
...
ask_water_data = str(raw_input('Get HF Water Data (Y/N) ?:   '))
print('\n')
...
print('\n')
ask_facility_data = str(raw_input('Get Facility Data (Y/N) ?:   '))
print('\n')
